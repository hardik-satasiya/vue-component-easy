...
},{"oMfpAn":1}],4:[function(require,module,exports){
...
test = {
	data: function() {
	  return {
	    ...
	    // because we'll use a different approach
	    // in the next article anyway
	    'message': 'hardik working now'
	  };
	},

	ready () {
		console.log('vue file loaded.');
	},
	methods: {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-c291c92a", module.exports)
  } else {
    hotAPI.update("_v-c291c92a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
_vue2.default.config.delimiters = ['[[', ']]']; // main.js
...
var parentVue = new _vue2.default({
	el: 'body',
	data: parentData,
	ready: function ready() {
	...
	components: {
		'comp-app': _component2.default,
		'test': _test2.default
	},
	methods: {}
});

},{"./component":5,"./components/test.vue":6,"vue":3}]},{},[7])